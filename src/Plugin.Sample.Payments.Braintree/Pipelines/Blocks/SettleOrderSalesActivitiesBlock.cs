...
namespace Plugin.Sample.Payments.Braintree
{
    ...
    public class SettleOrderSalesActivitiesBlock : AsyncPipelineBlock<Order, Order, CommercePipelineExecutionContext>
    {
        ...
        public override async Task<Order> RunAsync(Order arg, CommercePipelineExecutionContext context)
        {
            ...
            await _commander.Pipeline<IMoveEntitiesInListsPipeline>().RunAsync(argument, context.CommerceContext.PipelineContextOptions).ConfigureAwait(false);
