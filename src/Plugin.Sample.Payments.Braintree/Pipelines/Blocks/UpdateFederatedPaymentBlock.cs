...
namespace Plugin.Sample.Payments.Braintree
{
    ...
    public class UpdateFederatedPaymentBlock : AsyncPipelineBlock<Order, Order, CommercePipelineExecutionContext>
    {
        ...
        protected virtual async Task GenerateSalesActivity(Order order, PaymentComponent payment, CommercePipelineExecutionContext context)
        {
            ...
            await _persistEntityPipeline.RunAsync(new PersistEntityArgument(salesActivity), context).ConfigureAwait(false);
        }
    }
}
