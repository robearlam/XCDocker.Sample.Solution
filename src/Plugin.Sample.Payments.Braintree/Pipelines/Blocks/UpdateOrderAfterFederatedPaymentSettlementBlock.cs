...
namespace Plugin.Sample.Payments.Braintree
{
    ...
    public class UpdateOrderAfterFederatedPaymentSettlementBlock : AsyncPipelineBlock<SalesActivity, SalesActivity, CommercePipelineExecutionContext>
    {
        ...
        /// </returns>
        public override async Task<SalesActivity> RunAsync(SalesActivity arg, CommercePipelineExecutionContext context)
        {
            ...
            await _persistEntityPipeline.RunAsync(new PersistEntityArgument(order), context).ConfigureAwait(false);
